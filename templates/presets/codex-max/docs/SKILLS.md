...
Use this skill to execute an ExecPlan milestone-by-milestone, update the plan log, run validation, and stop only at completion or an evidence-backed blocker.

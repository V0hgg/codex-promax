...
Record the smallest command that validates a local change in this repository.
...
Use short bullets for recurring failures, what they usually mean, and the quickest way to confirm the root cause.

## Before Claiming Completion

List the minimum verification bar for code changes in this repository.
